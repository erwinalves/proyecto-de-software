class Documento < ActiveRecord::Base
    ...
    validates :fecha_emision, format: { with: /\A[a-zA-Z]+\z/, message: "Solo se aceptan letras" }
    #validacion / en fecha
    validates :fecha_emision, presence: true, if: :paid_with_diagonal?
