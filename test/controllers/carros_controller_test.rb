...
class CarrosControllerTest < ActionController::TestCase
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post :create, carro: { cantidad_producto: @carro.cantidad_producto, invoices_id: @carro.invoices_id, product_id: @carro.product_id, ticket_id: @carro.ticket_id }
    end
  ...
  test "should update carro" do
    patch :update, id: @carro, carro: { cantidad_producto: @carro.cantidad_producto, invoices_id: @carro.invoices_id, product_id: @carro.product_id, ticket_id: @carro.ticket_id }
    assert_redirected_to carro_path(assigns(:carro))
  end
