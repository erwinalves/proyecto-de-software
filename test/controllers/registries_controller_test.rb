...
class RegistriesControllerTest < ActionController::TestCase
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post :create, registry: { ingreso: @registry.ingreso, people_id: @registry.people_id, salida: @registry.salida }
    end
  ...
  test "should update registry" do
    patch :update, id: @registry, registry: { ingreso: @registry.ingreso, people_id: @registry.people_id, salida: @registry.salida }
    assert_redirected_to registry_path(assigns(:registry))
  end
